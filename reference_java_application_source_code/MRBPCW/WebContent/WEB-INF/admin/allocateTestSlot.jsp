...
<div style = "display:block; height:auto; margin-left:15px;">
	<h1 class="pageTitle" title="Allocate Test Centres">Allocate Test Slot</h1>
</div>
...
<div style = "margin-left:15px;">
				<s:submit cssClass="submitBtn button-gradient" title='Generate' key='agencypublishdetails.generates' method='allocateTestSlots' />
</div>
<br/>
