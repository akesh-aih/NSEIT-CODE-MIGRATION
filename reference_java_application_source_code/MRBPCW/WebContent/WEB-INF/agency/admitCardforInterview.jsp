...
<h1 class="pageTitle" title="Generate Admit Card for Interview">Generate Admit Card for Interview</h1>
<div class="hr-underline2"></div>
<s:actionmessage escape="false" cssClass="msgg"/>
 
<s:form action="ReportAction_downloadCallLetterInterview.action">
<s:hidden name="menuKey" value="%{#session['menuKey']}"></s:hidden>
<input type="submit" value="Generate Call Letter for Interview" class="submitBtn button-gradient"/>
<s:token />
</s:form>
</div>
