...
<h1 class="pageTitle" title="Generate Admit Card for Medical Test">Generate Admit Card for Medical Test</h1>
<div class="hr-underline2"></div>
 
<s:actionmessage escape="false" cssClass="msgg"/>
<s:form action="ReportAction_downloadCallLetterMedicalTest.action">
<s:hidden name="menuKey" value="%{#session['menuKey']}"></s:hidden>
<input type="submit" value="Generate Call Letter for Medical Test" class="submitBtn button-gradient"/>
<s:token />
</s:form>
<!-- Box Container End -->
</div>
