...
function goToApprovalPage(){
		...
		$("#approvalReceiptForm").attr('action',"CandidateMgmtAction_getEligibleAndNonEligibleCandidateDataForNodal.action");
...
<s:hidden name = "commTaluka" id = "commTaluka" value="%{commTaluka}"></s:hidden>
...
<h1 class="pageTitle" title="Photograph Upload">Registration Acknowledgement Receipt</h1>
...
<div style="display:block; min-height:300px; height:auto;">
  <table width="700" align="center" cellpadding="7" style="border:#333 3px double; line-height:140%;" >
    <tr>
      <td align="center" >
      <div class="lighttext" style="text-align:right; height:25px;">HELP CENTER COPY</div>    
      ...
      <td ><table width="100%" border="0" cellspacing="0" cellpadding="7">
        ...
        <tr>
          <td colspan="2" valign="top"><strong>Verified On : <s:property value="regApprovalDate"/><br />
            ...
            <strong>District    : </strong><s:property value="commDistrict"/><br />
...
<br />
  <table width="700" align="center" cellpadding="7" style="border:#333 3px double; line-height:140%;" >
    <tr>
      <td align="center" >
      <div class="lighttext" style="text-align:right; height:25px;">CANDIDATE COPY</div>
