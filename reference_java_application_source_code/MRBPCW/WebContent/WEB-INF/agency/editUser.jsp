...
$(document).ready(function() {
		...
		if(roleType!=0){
			...
			$("#confirmPasswordtxt").val($("#passwordtxt").val());
		}
	});

	function changeActionEdit() {
		$("#ModuleMasterId").attr('action',
				"UserMasterAction_updateUserDetails.action");
				...
				<tr>
						...
						<td>
							...
							<s:select name="roleTypeA" id="roleType" headerKey="0"
								...
								onchange="getRole()" disabled="true" value="%{roleType}"/>
					...
					<td class="field-label">
						...
						<td>
							<s:textfield name="userId" value="%{userId}" id="moduleName" size="20" maxlength="50" onpaste="return false;" readonly="true" onkeypress="return alphaNumericOnly(event);" autocomplete="off"></s:textfield>
						</td>
					<td class="field-label">
							User Name <span class="manadetory-fields">*</span>
						</td>
						<td>
							<s:textfield name="userName" value="%{userName}" id="moduleName" size="20" maxlength="200" onpaste="return false;" onkeypress=" return nameValidator(event);" autocomplete="off"></s:textfield>
						</td>
					</tr>
					<tr>
					<td class="field-label">
						...
						<td>
							<s:textfield name="email" value="%{email}"  id="moduleName" size="20" maxlength="100" onpaste="return false;"></s:textfield>
						</td>
					<td class="field-label">
							Mobile Number <span class="manadetory-fields">*</span>
						</td>
						<td>
							<s:textfield name="mobile" value="%{mobile}" id="moduleName" size="20" maxlength="10" onpaste="return false;"></s:textfield>
						</td>
					</tr>
					<tr>
					<td class="field-label">
						...
						<td>
							<s:password name="password" id="password" size="22" maxlength="50" />
							<s:hidden name="passwordtxt" id="passwordtxt" value="%{password}" />
						</td>
					<td class="field-label">
							Confirm Password <span class="manadetory-fields">*</span>
						</td>
						<td>
							<s:password name="confirmPassword" id="confirmPasswordtxt" size="22" maxlength="50" />
						</td>
					</tr>
					<tr>
						<td class="field-label">Status</td><td><s:iterator value="selectList">
						...
						<div>
							<table align="right">
								<tr>
									...
									<td>
										<input type="button" value="Update" title="Save "
											class="submitBtn button-gradient"
											onclick="changeActionEdit();" />&nbsp;&nbsp;
									</td>
									<td>
