...
<div id="pop3"></div>
<h1 class="pageTitle" title="Enrollment Details"><s:text name="Registration Report Filter"/></h1>
				...
				<table width="400" align="center" cellpadding="5">
					<tr>
						<td>
							<div align="left">
								...
								list="reportTypeList" id="labelId" 
					...
					<tr>
						<td>
							<div align="left">
								<s:text name="Format  :    " />
								<s:radio list="formatList" name="format" cssClass="validate[required]" id="formatList"></s:radio>
							</div>
									<!-- for validation messages -->
										<br/>
										<br/>
