...
function open_win()
{
	...
	window.open("AgencyAction_generateSelectedCandidateReport.action?programName="+$("#programName").val()+
...
<h1 class="pageTitle" title="Personal Details">Selected Candidates Report</h1>
