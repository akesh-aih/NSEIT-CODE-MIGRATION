...
{
		window.open("UploadManagementAction_downloadInterviewTemplate.action");
		return false;
}  
	</script>

	<s:form action="UploadManagementAction_uploadInterviewScoreCSV.action" enctype="multipart/form-data" method="post" id="uploadInterviewScoreCSV" onsubmit="return frm_onsubmit();">
		...
		<div id="dashboard" style="display:block; min-height:300px; height:auto;">
			<h1 class="pageTitle" title="Upload Candidate Interview Score"><s:text name="agencyupload.uploadInterviewScore"/></h1>
			...
			<div style="display:block; min-height:300px; height:auto;" >
				<table class="contenttable" width="100%">
					...
					<tr>
						...
						<td>
						<a href="javascript:void(0)" onclick="exportTemplate()" class="LinkAlignMiddle"><s:text name="agencyupload.downloadInterScorTemplate"/></a>
						</td>
					</tr>
					<tr>
    						...
    						<s:set var="webFramework" value="uploaded"/>
     						<s:if test="%{#webFramework=='true'}">
				    			<table width="100%">
				    				...
				    				<tr>
								    	<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.interviewScoreDetails"/></strong></td></tr>
								    <tr>
				    				...
				    				<tr>
				    					<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.errorUploadingInterScore"/></strong></td></tr>
				    				<tr>
