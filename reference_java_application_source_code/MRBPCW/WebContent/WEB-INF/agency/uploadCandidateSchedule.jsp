...
{
		window.open("UploadManagementAction_downloadScheduleTemplate.action");
		return false;
}  
	</script>

	<s:form action="UploadManagementAction_uploadScheduleCSV.action" enctype="multipart/form-data" method="post" id="uploadScheduleCSV" onsubmit="return frm_onsubmit();">
		...
		<div id="dashboard" style="display:block; min-height:300px; height:auto;">
			<h1 class="pageTitle" title="Upload Schedule For Written Test"><s:text name="agencyupload.uploadCandidateSchedule"/></h1>
			...
			<div style="display:block; min-height:300px; height:auto;" >
				<table class="contenttable  scheduleTable" width="100%" cellspacing="0" cellpadding="0"   >
					<tr>
						<td colspan="3">
					...
					<tr>
						...
						<td>
						<a href="javascript:void(0)" onclick="exportTemplate()" class="LinkAlignMiddle" ><s:text name="agencyupload.downloadCandidateScheTemplate"/></a>
						</td>
					</tr>
					<tr>
    						...
    						<s:set var="webFramework" value="uploaded"/>
     						<s:if test="%{#webFramework=='true'}">
				    			<table width="100%">
				    				...
				    				<tr>
								    	<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.updatedCandidateScheDetails"/></strong></td></tr>
								    <tr>
								    	<td widhth="100%" style="background:#effbf9;" colspan="2">
								    		<table width="100%" style="background:#effbf9;">
								    			<tr   >
				    				...
				    				<tr>
				    					<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.errorCandidateScheDetails"/></strong></td></tr>
				    				<tr>
