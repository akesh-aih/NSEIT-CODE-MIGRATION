...
{
		window.open("UploadManagementAction_downloadFieldTestScheduleTemplate.action");
		return false;
}  
	</script>

	<s:form action="UploadManagementAction_uploadFieldTestScheduleCSV.action" enctype="multipart/form-data" method="post" id="uploadScheduleCSV" onsubmit="return frm_onsubmit();">
		...
		<div id="dashboard" style="display:block; min-height:300px; height:auto;">
			<h1 class="pageTitle" title="Upload Candidate Field Test Schedule Details"><s:text name="agencyupload.uploadFieldTestSchedule"/></h1>
			...
			<div style="display:block; min-height:300px; height:auto;" >
				<table class="contenttable  scheduleTable" width="100%" cellspacing="0" cellpadding="0"   >
					...
					<tr>
						...
						<td>
						<a href="javascript:void(0)" onclick="exportTemplate()" class="LinkAlignMiddle" ><s:text name="agencyupload.downloadFieldTestSchedule"/></a>
						</td>
					</tr>
					<tr>
    						...
    						<s:set var="webFramework" value="uploaded"/>
     						<s:if test="%{#webFramework=='true'}">
				    			<table width="100%">
				    				...
				    				<tr>
								    	<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.updatedFieldTestSchedule"/></strong></td></tr>
								    <tr>
				    				...
				    				<tr>
				    					<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.errorForFieldTestSchedule"/></strong></td></tr>
				    				<tr>
