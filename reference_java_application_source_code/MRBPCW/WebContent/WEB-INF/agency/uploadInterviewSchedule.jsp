...
{
		window.open("UploadManagementAction_downloadInterviewScheduleTemplate.action");
		return false;
}  
	</script>

	<s:form action="UploadManagementAction_uploadInterviewScheduleCSV.action" enctype="multipart/form-data" method="post" id="uploadInterviewScheduleCSV" onsubmit="return frm_onsubmit();">
		...
		<div id="dashboard" style="display:block; min-height:300px; height:auto;">
			<h1 class="pageTitle" title="Upload Interview Schedule"><s:text name="agencyupload.uploadInterviewSchedule"/></h1>
			...
			<div style="display:block; min-height:300px; height:auto;" >
				<table class="contenttable" width="100%">
					...
					<tr>
						...
						<td>
						<a href="javascript:void(0)" onclick="exportTemplate()" class="LinkAlignMiddle" ><s:text name="agencyupload.downloadInterviewSchedule"/></a>
						</td>
					</tr>
					<tr>
    						...
    						<s:set var="webFramework" value="uploaded"/>
     						<s:if test="%{#webFramework=='true'}">
				    			<table width="100%">
				    				...
				    				<tr>
								    	<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.updatedInterviewSchedule"/></strong></td></tr>
								    <tr>
				    				...
				    				<tr>
				    					<td widhth="100%" style="background:#56b4a2; color:#fff;"><strong><s:text name="agencyupload.errorInterviewSchedule"/></strong></td></tr>
				    				<tr>
