	...
	<div >
		...
		<div align="left">
			...
			<s:if test='%{afterApplyVeiwPayment!=null && afterApplyVeiwPayment=="true"}'>
							...
							<strong>	Preferred District/City for Written Test  / </strong> <span class="tamil"><s:text name="application.testCenter"/></span> 
	...
	<div class="">
		...
		<s:if test='%{afterApplyVeiwPayment=="true"}'>
			<%--<input type="button" value="PDF Print" id="<s:property value='%{disciplineType}'/>"
				...
				<input type="button" value="Download" class="printBtn button-gradient" onclick="downloadPDF1();"/>
<!--				<input type="button" value="Print" id="<s:property value='%{disciplineType}'/>" class="printBtn button-gradient" onclick="open_win1(this.id);"/>-->
				</s:if>
		</s:if>
		<s:else>
			<%--<input type="button" value="PDF Print" class="printBtn button-gradient" onclick="open_win();"/>
			--%><input type="button" value="Print" class="printBtn button-gradient" onclick="window.print();"/>
		</s:else>
		</div>
