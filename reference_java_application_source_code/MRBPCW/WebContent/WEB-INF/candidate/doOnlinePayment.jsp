      ...
      <tr>
        <td height="0" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="brd3">
            ...
            <tr>
              ...
              <a href="javascript:;" id="a2" onclick="showme(2)" onmouseover="MouseOver(2)" onmouseout="MouseOut(2)" class="btop">Net Banking</a> 
              </div></td>
              <td valign="top"><div id="r_side_link">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="20%">
                          ...
                          --%>
                          <input type="radio" name="creditCardType" value="2" />
                          VISA<br>
                  ...
                  <div id="n2">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="20%"><input type="radio" name="bankPageType" id="bankPageType1" checked="checked"/>
                          ICICI Bank<br>
                          <input type="radio" name="bankPageType" id="bankPageType2"/>
                          Vijaya Bank
                          </td>
                      </tr>
                    </table>
