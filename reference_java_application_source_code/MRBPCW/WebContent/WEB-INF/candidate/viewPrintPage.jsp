...
<script type="text/javascript">
	$(document).ready(function() {
		var categoryotherthanUR = '<s:property value="%{categoryVal}" />';
		if (categoryotherthanUR == "UR" || categoryotherthanUR == "EWS") {
			$('.caste').hide();
		} else {
			$('.caste').show();
		}
	...
	function open_window() {
		...
		document.applicationPdf.action = "CandidateAction_getApplicationPDF.action?flag=view";
	...
	$(document).ready(function() {
		...
		$("#checkbox3").click(function() {
			var checkVal3 = $("#checkbox3").is(":checked");
			if (checkVal3) {
				checked3 = true;
				enableContinuebtn();
			} else {
		...
		$("#checkbox4").click(function() {
			var checkVal4 = $("#checkbox4").is(":checked");
			if (checkVal4) {
				checked4 = true;
				enableContinuebtn();
			} else {
		...
		$("#checkbox5").click(function() {
			var checkVal5 = $("#checkbox5").is(":checked");
			if (checkVal5) {
				checked5 = true;
				enableContinuebtn();
			} else {
		...
		$("#checkbox6").click(function() {
			var checkVal6 = $("#checkbox6").is(":checked");
			if (checkVal6) {
				checked6 = true;
				enableContinuebtn();
			} else {
		...
		$("#checkbox7").click(function() {
			var checkVal7 = $("#checkbox7").is(":checked");
			if (checkVal7) {
				checked7 = true;
				enableContinuebtn();
			} else {
		...
		function loadPImage() {
			$.ajax({
				...
				error : function(err) {
					...
					document
							.getElementById("inputStreamForImage").src = "data:image/png;base64,"
							+ results;
				},
		...
		function loadImage() {
			$.ajax({
				...
				error : function(err) {
					...
					//the results is a base64 string.  convert it to an image and assign as 'src'
					document
							.getElementById("inputStreamForImage1").src = "data:image/png;base64,"
							+ results;
				},
				success : function(data) {
					var results = data;
...
<div class="container-fluid ViewpageLabel">
	<div id="dashboard">
		...
		<div class="titlebg container">
			<h1 class="pageTitle">
				<strong> View <%-- <s:text
						name="header.view" /> --%></strong> <span class="userid_txt"> <s:if
		...
		<div class="padding_leftright">
			<s:form id="applicationForm" name="formDtls"
				...
				<div class="container common_dashboard tabDiv effect2">
					...
					<%-- <div class="row">
						<div class="col-sm-12">
							<span class="orgNote"> <b>Note:</b> Candidates are advised
								...
								Candidate Dashboard. <span class="tamil"> <s:text
										name="note.ctrlprint" /></span>
							</span>
						</div>
					</div> --%>
					<!-- <div style="text-align: center">
							<a href="javascript:void(0)"
								onclick="goToMenu('CandidateAction_getCandidateDetails.action')">Click
								Here to Edit Application</a>
						</div> -->
					...
					<div class="accordions">
						<div id="UploadDiv">
							<h1 title="Upload Documents" class="pageTitle">Upload
								Documents</h1>
							<div class="accordion">
											...
											<tr>
												<td width="50%"><span
													style="width: 90%; display: inline-block;"> <s:property
															value="docLabel1" /> <%-- <s:if test="ocdFlagValue=='CC'">
													<s:text name="communityblue" />
												</s:if> <s:if test="ocdFlagValue=='SSLC'">
													<s:text name="xblue" />
												</s:if> <s:if test="ocdFlagValue=='HSC'">
													<s:text name="xiiblue" />
												</s:if> <s:if test="ocdFlagValue=='DIPLOMA'">
													<s:text name="dipblue" />
												</s:if> <s:if test="ocdFlagValue=='DEGREE'">
													<s:text name="ugblue" />
												</s:if> <s:if test="ocdFlagValue=='PG'">
													<s:text name="pgblue" />
												</s:if> <s:if test="ocdFlagValue=='NATIVITY'">
						...
						<div id="DeclarationDiv">
							...
							<table class="ml20">
								<tr>
									...
									<td><span class="font14 english_ins"> I accept all
											the above declarations.</span></td>
								</tr>
								<tr>
									<td
										style="display: inline-block; width: 20px; margin-top: 2px;">
									...
									<td><span class="font14 english_ins"> I have
											ensured that everything has been filled correctly, before
											...
											ensure that they are correct. I have found that the details
											are correct, and now proceed to make online payment towards
											application fees.</span></td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-6 col-xs-12 text-left">
							<p class="font14 WeightBold mt50">
								Submitted Date:
								<s:property value="regFormSubmitedDate" />
							</p>
						</div>
