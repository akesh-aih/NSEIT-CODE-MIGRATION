...
<!--<script src="../../../Downloads/pdfmake-master/examples/margins.js"></script>-->
<!--<script src="../../../Downloads/pdfmake-master/examples/tables.js"></script>-->
<!--<script src="../../../Downloads/pdfmake-master/examples/textDecorations.js"></script>-->
...
<script type="text/javascript"><!--
        ...
        contentCheck.push({
            ...
            table: {
                ...
                body: [
                    [
                        {
                            text: [{text: 'APPLICATION FOR COMMON RECRUITMENT 2019', bold: true}]
                        }
                    ]
                ]
            },
    ...
    if (dataObj.post1 != null && dataObj.post1 != "") {
   	 contentCheck.push({
            fontSize: fontSize,
            table: {
                widths: [170, '*'],
                ...
                body: [
                    [
                        {
                            text: [{text: 'Preference ' + 1 + ' / ', bold: true}, {
                                text: 'விருப்பப்பதவி ', font: 'latha'
                            }, 1]
                        },
                        {text: returnStringIfNull(dataObj.post1), bold: true}
                    ]
                ]
            },
            layout: 'noBorders'
   	...
   	if (dataObj.post2 != null && dataObj.post2 != "") {
      	 contentCheck.push({
               fontSize: fontSize,
               table: {
                   widths: [170, '*'],
                   ...
                   body: [
                       [
                           {
                               text: [{text: 'Preference ' + 2 + ' / ', bold: true}, {
                                   text: 'விருப்பப்பதவி ', font: 'latha'
                               }, 2]
                           },
                           {text: returnStringIfNull(dataObj.post2), bold: true}
                       ]
                   ]
               },
               layout: 'noBorders'
      	...
      	if (dataObj.post3 != null && dataObj.post3 != "") {
      	   	 contentCheck.push({
      	            fontSize: fontSize,
      	            table: {
      	                widths: [170, '*'],
      	                ...
      	                body: [
      	                    [
      	                        {
      	                            text: [{text: 'Preference ' + 3 + ' / ', bold: true}, {
      	                                text: 'விருப்பப்பதவி ', font: 'latha'
      	                            }, 3]
      	                        },
      	                        {text: returnStringIfNull(dataObj.post3), bold: true}
      	                    ]
      	                ]
      	            },
      	            layout: 'noBorders'
...
/*
    ...
    if (dataObj.religionBelief.toLowerCase() == "other") {
        contentCheck.push({
            table: {
                widths: [170, '*'],
                headerRows: 1,
...
*/
    ...
    /*  if (returnStringIfNull(dataObj.wkExperienceDtlsList[0].policedept) != null && 
    		 returnStringIfNull(dataObj.wkExperienceDtlsList[0].policedept) !='') {
 ...
 if(specialOption != null && specialOption == "3") { // condition to hide the special marks heading 
    ...
    if ((dataObj.getAgeQuotaDetailsRadioChk != null && dataObj.getAgeQuotaDetailsRadioChk != '3') || (dataObj.underQuotaOption != null && dataObj.underQuotaOption != '1')) {
        ...
        if (dataObj.additionalDetailsBean.sportsQuaota != null) {
            ...
            if (returnStringIfNull(dataObj.additionalDetailsBean.sportsQuaota) == "Yes") {
                contentCheck.push({
                    table: {
                        widths: [170, '*'],
                        headerRows: 1,
                        body: [
                            [
                                {
                                    text: ['Sport In Which Participated / ', {
                                        text: 'பங்குபெற்ற விளையாட்டு ',
                                        font: 'latha',
                                    }]
                                },
                                [
                                    {text: returnStringIfNull(dataObj.additionalDetailsBean.sportsName), bold: true}
                                ],
                            ]
                        ]
                    }, layout: 'noBorders'
                            ...
                            [
                                {
                                    text: ['Event / Tournament Name /', {
                                        text: ' நிகழ்வு /  போட்டியின் பெயர் ',
                                        font: 'latha',
                                    }]
                                },
                                [
                                    {text: returnStringIfNull(dataObj.additionalDetailsBean.eventName), bold: true}
                                ],
                            ]
                        ]
                    }, layout: 'noBorders'
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {
                                    text: ['Date Of Start Of Event /', {
                                        text: ' நிகழ்வு தொடங்கிய நாள்   ',
                                        font: 'latha',
                                    }]
                                },
                                [
                                    {text: returnStringIfNull(dataObj.additionalDetailsBean.dateOfStartEvent), bold: true}
                                ],
                            ]
                        ]
                    }, layout: 'noBorders'
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {
                                    text: ['Date Of Completion Of Event / ', {
                                        text: 'நிகழ்வு நிறைவுற்ற நாள் ',
                                        font: 'latha',
                                    }]
                                },
                                [
                                    {text: returnStringIfNull(dataObj.additionalDetailsBean.dateOfComplEvent), bold: true}
                                ],
                            ]
                        ]
                    }, layout: 'noBorders'
                    ...
                    table: {
                        ...
                        body: [
                            [
                                {
                                    text: ['Select Level Of Participation / ', {
                                        text: 'பங்கேற்றதின் நிலை',
                                        font: 'latha',
                                    }]
                                },
                                [
                                    {text: returnStringIfNull(dataObj.additionalDetailsBean.participationvel), bold: true}
                                ],
                            ]
                        ]
                    }, layout: 'noBorders'
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                [
                                    {
                                        text: returnStringIfNull(dataObj.additionalDetailsBean.sportsCertificateNumber),
                                        bold: true
                                    }
                                ],
                            ]
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                [
                                    {
                                        text: returnStringIfNull(dataObj.additionalDetailsBean.sportsCertIssuingAuthority),
                                        bold: true
                                    }
                                ],
                            ]
                    ...
                    table: {
                        ...
                        body: [
                            [
                                ...
                                [
                                    {
                                        text: returnStringIfNull(dataObj.additionalDetailsBean.dateOfsportsCertificate),
                                        bold: true
                                    }
                                ],
                            ]
