...
<link href="css/1bootstrap.min.css" rel="stylesheet" type="text/css" media="screen" />
...
<script>
	function continueRegPage() {
		$("#instructionForm").attr('action', "LoginAction_registerCandidate.action");
			...
			<div class="row">
				...
				<div class="col-xs-12">
					<input type="button" onclick="continueRegPage();" value="Continue"
						id="continue" class="btn btn-warning" disabled />
				</div>
			</div>
		</form>
