...
<%--			    <font color="red"><%=pagination.getPage_records() %></font> Candidates Found--%>
			  ...
			  <td class="pagination-label" nowrap="nowrap">of <%=pagination.getTotal_pages()%><input type="hidden" name="hidTotalPages" value=<%=pagination.getTotal_pages()%>></td>
			  ...
			  <td class="pagination-linkoff" style="" nowrap="nowrap">
			  	<s:select onchange="fnPagination(5,0);" list="#{'0':'All','10':'10','25':'25','50':'50','100':'100'}" theme="simple" name="pagination.page_size" id="page_size" value="#request.pagination.page_size"/>
			  	<!--for getting all record: '0':'All' -->
			  </td>
			</tr>
		</table>
