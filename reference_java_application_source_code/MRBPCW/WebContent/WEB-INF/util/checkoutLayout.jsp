...
<meta http-equiv="Content-Security-Policy" content="script-src * 'self' 'unsafe-eval' 'unsafe-inline' blob: data: gap: https://pgtest.atomtech.in/staticdata/ots/js/atomcheckout.js">
