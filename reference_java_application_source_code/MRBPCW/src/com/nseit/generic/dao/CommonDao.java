...
public interface CommonDao {
	...
	public List<EmailSMSMasterBean> getEmailSMSMasterList() throws Exception;
	...
	public List<Map<String, String>> getMenuForAll() throws Exception;

	public void updateEmailSMSStatusPostSending(final List<EmailSMSTransactionBean> lstEmailSMSTransactionBeans) throws Exception;
	...
	public int insertOTPDetails1(EmailSMSTransactionBean emailSMSBean, String emailId);
