	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (strSaveInS3 != null && !Strings.isBlank(strSaveInS3) && "true".equals(strSaveInS3.toLowerCase())) {
				UploadPhotoSignInS3sdkV2 uploadSignInS3sdkV2 = new UploadPhotoSignInS3sdkV2();
				byte[] byteArrayOfPhotoSignFromCandFolderInS3 = uploadSignInS3sdkV2.getByteArrayOfPhotoSignFromCandFolderInS3(users, "_sign.jpg");
				...
				File filePath = new File(DocumentPath + File.separator + users.getUsername() + File.separator + users.getUsername() + "_sign.jpg");
				//logger.info("==== File Path for Retrieving Sign ==== "+filePath);
